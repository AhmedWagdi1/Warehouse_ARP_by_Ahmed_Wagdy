...
class BuyInvoice(models.Model):
    product = models.ForeignKey(Product, on_delete=DO_NOTHING)
    product2 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product2b', default=1, blank=True,
                                 null=True)
    product3 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product3b', blank=True, default=1,
                                 null=True)
    product4 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product4b', blank=True, default=1,
                                 null=True)
    product5 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product5b', blank=True, default=1,
                                 null=True)
    product6 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product6b', blank=True, default=1,
                                 null=True)
    product7 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product7b', blank=True, default=1,
                                 null=True)
    product8 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product8b', blank=True, default=1,
                                 null=True)
    product9 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product9b', blank=True, default=1,
                                 null=True)
    product10 = models.ForeignKey(Product, on_delete=DO_NOTHING, related_name='product10b', blank=True, default=1,
                                  null=True)
    invoice_description = models.CharField(max_length=260, default='البيان')
    invoice_description2 = models.CharField(max_length=260, default='البيان', blank=True, null=True)
    invoice_description3 = models.CharField(max_length=260, default='البيان', blank=True, null=True)
